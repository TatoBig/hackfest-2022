  ...
  return (
    <>
      <ObjectiveContent text=" Aplicar el Marco Decenal de Programas sobre Modalidades de Consumo y
          ...
          " image="https://cdn.pixabay.com/photo/2018/10/20/11/50/united-nations-3760656_960_720.jpg"
      />
      <ObjectiveContent right text=" De aquí a 2030, lograr la gestión sostenible y el uso eficiente de los
            recursos naturales." image="https://cdn.pixabay.com/photo/2013/10/14/13/17/dragline-195440_960_720.jpg"
      />
      ...
      <ObjectiveContent text="   De aquí a 2030, reducir considerablemente la generación de desechos
          ...
          " image="https://cdn.pixabay.com/photo/2018/11/26/10/43/ally-3839139_960_720.jpg"
      />
      <ObjectiveContent right text="Alentar a las empresas, en especial las grandes empresas y las empresas
      ...
      <ObjectiveContent text=" Promover prácticas de adquisición pública que sean sostenibles, de conformidad
                con las políticas y prioridades nacionales." image="https://cdn.pixabay.com/photo/2016/10/16/13/06/new-york-1745089_960_720.jpg"
      />
      <ObjectiveContent right text="  De aquí a 2030, asegurar que las personas de todo el mundo tengan la información y
            los conocimientos pertinentes para el desarrollo sostenible y los estilos de vida
            en armonía con la naturaleza." image="https://cdn.pixabay.com/photo/2018/01/17/07/06/laptop-3087585_960_720.jpg"
      />
      <ObjectiveContent text=" Ayudar a los países en desarrollo a fortalecer su capacidad científica y tecnológica
            para avanzar hacia modalidades de consumo y producción más sostenibles." image="https://cdn.pixabay.com/photo/2013/11/28/10/03/people-219985_960_720.jpg"
      />
      <ObjectiveContent right text=" Elaborar y aplicar instrumentos para vigilar los efectos en el desarrollo sostenible, a fin
